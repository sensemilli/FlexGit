...
In 1920x1200 1xAA, using HARDWARE_DEPTHS as input and BLUR_RADIUS_8, the RenderAO call takes 
up to 46 MB of video memory and the following GPU times:
- On GeForce GTX 680: 2.7 ms / frame
- On GeForce GTX 980: 1.6 ms / frame
...
//    * The OutputFBO cannot contain a texture bound in pInputData.
//
// Returns:
//     GFSDK_SSAO_NULL_ARGUMENT                        - One of the required argument pointers is NULL
//     GFSDK_SSAO_INVALID_PROJECTION_MATRIX            - The projection matrix is not valid
