...
#ifndef NX_VORTEX_FSPREVIEW_H
#define NX_VORTEX_FSPREVIEW_H
...
*/
static const physx::PxU32 VORTEX_DRAW_NOTHING = 0x00;
/**
	\def VORTEX_DRAW_BOX
	Draw the box.  The top of the box should be above ground and the bottom should be below ground.
*/
static const physx::PxU32 VORTEX_DRAW_SHAPE = 0x01;
/**
	\def VORTEX_DRAW_GRIDS
...
static const physx::PxU32 VORTEX_DRAW_ASSET_INFO = 0x02;
/**
	\def VORTEX_DRAW_FULL_DETAIL
	Draw all of the preview rendering items.
*/
static const physx::PxU32 VORTEX_DRAW_FULL_DETAIL = (VORTEX_DRAW_SHAPE + VORTEX_DRAW_ASSET_INFO);
}
...
*/
class NxVortexFSPreview : public NxApexAssetPreview
{
public:
	/**
	...
	*/
	...
	The defines for the individual items are:<br>
		VORTEX_DRAW_NOTHING - draw nothing<BR>
		VORTEX_DRAW_BOX - draw the box<BR>
		VORTEX_DRAW_COLLISION_IMPLICIT - draw the collision implicit<BR>
		VORTEX_DRAW_GRIDS - draw the top and bottom grids of the box<BR>
