...
#ifndef NX_NOISE_FSACTOR_H
#define NX_NOISE_FSACTOR_H
 ...
 */
class NxNoiseFSActor : public NxApexActor, public NxApexRenderable
{
protected:
	virtual ~NxNoiseFSActor() {}

public:
	/**
	\brief Returns the asset the instance has been created from.
	*/
	virtual NxBasicFSAsset* 	getNoiseFSAsset() const = 0;
	...
	*/
	virtual void				setNoiseStrength(physx::PxF32) = 0;
