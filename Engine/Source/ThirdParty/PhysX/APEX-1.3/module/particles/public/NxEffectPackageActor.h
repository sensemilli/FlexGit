...
// Forward reference the PxTransform and PxRigidDynamic class
class PxTransform;
...
public:
	...
	*/
	virtual PxRigidDynamic* getEffectRigidDynamic(PxU32 effectIndex) const  = 0;
	...
	*/
	virtual const char * hasVolumeRenderMaterial(physx::PxU32 &index) const = 0;
