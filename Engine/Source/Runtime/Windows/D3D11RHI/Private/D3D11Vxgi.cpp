...
void FD3D11DynamicRHI::RHIVXGIApplyDrawStateButNotShaders(const NVRHI::DrawCallState& DrawCallState)
{
	VxgiRendererD3D11->applyState(DrawCallState, false);
}
...
void FD3D11DynamicRHI::RHISetViewportsAndScissorRects(uint32 Count, const FViewportBounds* Viewports, const FScissorRect* ScissorRects)
{
	StateCache.SetViewports(Count, (D3D11_VIEWPORT*)Viewports);
	// TODO: SetScissorRects?
}
